...
// Adding a new element in the last of the main array (numbers) using 'push()' method
numbers.push(63);
console.log("The array (numbers) after adding an element in the last:", numbers);
// Output || The array (numbers) after adding an element in the last: [ 78, 45, 98, 45, 63 ]
console.log("New length of the array (numbers) after adding an element in the last:", numbers.length);
// Output || New length of the array (numbers) after adding an element in the last: 5

// We can also add more than one element in the last of an array using 'push()' method
numbers.push(65, 66);
console.log("The array (numbers) after adding more than one element in the last:", numbers);
// Output || The array (numbers) after adding more than one element in the last: [ 78, 45, 98, 45, 63, 65, 66 ]
console.log("New length of the array (numbers) after adding more than one element in the last:", numbers.length);
// Output || New length of the array (numbers) after adding more than one element in the last: 7 
*/
